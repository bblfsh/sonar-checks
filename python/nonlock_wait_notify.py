# check: https://rules.sonarsource.com/java/RSPEC-2273
import utils
...
uast = client.parse("../java/nonlock_wait_notify.java").uast
...
for node in nodes_all:
    ...
    print("wait()/notify()/notifyAll() calls not inside synchronized blocks "
            "or methods, line: {}".format(node.start_position.line))
