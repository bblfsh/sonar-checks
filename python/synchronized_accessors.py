# check: https://rules.sonarsource.com/java/RSPEC-2886
import utils
...
uast = client.parse("../java/synchronized_accessors.java").uast
...
for cl in cl_nodes:
    ...
    for property_, getter in getters.items():
        ...
        if sync in getter.modifiers and sync not in setter.modifiers or\
            ...
            print("Getter and setter for '%s' should both or none be synchronized" % property_)
